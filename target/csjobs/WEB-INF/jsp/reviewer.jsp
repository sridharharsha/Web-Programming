		...
		<table class="table table-condensed table-striped table-hover table-bordered" border="1">
			...
			<c:forEach items="${jobs}" var="job">
				...
				<tr>
					...
					<td><a href="applications.html?id=${job.id}" class="btn btn-default">Applications</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
				...
				<tr>
					<th>Applications</th>
						...
						<c:forEach items="${applications }" var="application">
								<a href="<c:url value='/application.html' />">${application.applicant.firstName} ${application.applicant.lastName}</a><br/>
						</c:forEach>
						</td>
				</tr>
				</c:if>-->
